        ...
        case T_BINOP: {
            switch(e->u.BINOP.op) {
                ...
                case T_div: {
                    ...
                    emit(AS_Oper("cqto\n", Temp_TempList(rax, Temp_TempList(rdx, NULL)),
                        NULL, NULL));
...
static Temp_tempList munchArgs(int num, T_expList args) {
    ...
    if(num < 6) {
        ...
        emit(AS_Oper("pushq `s0", NULL, Temp_TempList(arg, NULL), NULL));
    }
